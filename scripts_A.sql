...
--possible tbs -homegames - attendance; games played. I need park info--parks also use homegames tbl to connect parks tbl. Don't need anything from homegames tbl. tbl --teams tbl for team info.
